...
struct Diccionario {
    ...
    void load_sample() {
        cat = {
            {"N", {
                "corazon","ciudad","mar","noche","camino","lluvia","viento","destino",
                "silencio","sombra","cielo","fuego","arena","luz","viaje","alma",
                "mirada","sol","estrella","tormenta"
            }},
            {"V", {
                "late","brilla","canta","corre","susurra","grita","camina","suena",
                "florece","cae","renace","avanza","respira","tiembla","crece"
            }},
            {"Adj", {
                "oscuro","silencioso","eterno","dulce","brillante","profundo",
                "fragil","sombrio","ardiente","luminoso","infinito"
            }},
            {"P", {"en","sobre","bajo","entre","tras","contra","hacia","junto a"}},
            {"S", {"mi","tu","nuestro","su","vuestro"}},
            {"C", {
                "de la madrugada","sin final","de papel","del viento","del amanecer",
                "de mis sueños","del silencio interior"
            }}
        };
    }
};
